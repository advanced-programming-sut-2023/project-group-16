...
public class GS implements GroupStrategy, Disposable {
    ...
    public GS(Camera camera) {
        this.camera = camera;
        this.cameraSorter = new Comparator<Decal>() {
            @Override
            public int compare(Decal o1, Decal o2) {
                float dist1 = GS.this.camera.position.dst(o1.getPosition());
                float dist2 = GS.this.camera.position.dst(o2.getPosition());
    ...
    public GS(Camera camera, Comparator<Decal> sorter) {
        this.camera = camera;
