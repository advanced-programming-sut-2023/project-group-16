...
public enum EconomicBuildingDetail {
    SMALL_STONE_GATEHOUSE(new ProductData[]{}, new StorageData[]{}, 0, null, 1000, 0, 0, BuildingType.SMALL_STONE_GATEHOUSE),
    LARGE_STONE_GATEHOUSE(new ProductData[]{}, new StorageData[]{}, 0, null, 2000, 0, 0, BuildingType.LARGE_STONE_GATEHOUSE),
    ARMOURY(new ProductData[]{}, new StorageData[]{
    ...
    }, new StorageData[]{}, 0, null, 300, 0, 0, BuildingType.BARRACKS),
    ...
    }, new StorageData[]{}, 0, null, 300, 0, 0, BuildingType.MERCENARY_POST),
    ...
    }, new StorageData[]{}, 0, null, 300, 0, 0, BuildingType.ENGINEER_GUILD),

    INN(new ProductData[]{}, new StorageData[]{}, 0, new EconomyEffect() {
        @Override
    ...
    MILL(new ProductData[]{new ProductData(Food.FLOUR, true, 10)}, new StorageData[]{}, 0, null, 300, 3, 0, BuildingType.MILL),
    IRON_MINE(new ProductData[]{new ProductData(BasicResource.IRON, true, 1)}, new StorageData[]{}, 0, null, 300, 2, 0, BuildingType.IRON_MINE),
    MARKET(new ProductData[]{}, new StorageData[]{}, 0, null, 300, 1, 0, BuildingType.MARKET),
    OX_TETHER(new ProductData[]{new ProductData(BasicResource.STONE, true, 10)}, new StorageData[]{}, 0, null, 300, 1, 0, BuildingType.OX_TETHER),
    PITCH_RIG(new ProductData[]{new ProductData(BasicResource.OIL, true, 10)}, new StorageData[]{}, 0, null, 300, 1, 0, BuildingType.PITCH_RIG),
    ...
    STOCKPILE(new ProductData[]{}, new StorageData[]{
    ...
    WOOD_CUTTER(new ProductData[]{new ProductData(BasicResource.WOOD, true, 10)}, new StorageData[]{}, 0, null, 300, 1, 0, BuildingType.WOOD_CUTTER),
    HOVEL(new ProductData[]{}, new StorageData[]{}, 0, null, 100, 0, 0, BuildingType.HOVEL),
    CHURCH(new ProductData[]{}, new StorageData[]{}, 0, new EconomyEffect() {
        @Override
        public void applyEffect(Kingdom kingdom) {
            kingdom.addPopularity(2);
        }
    }, 800, 0, 0, BuildingType.CHURCH),
    CATHEDRAL(new ProductData[]{new ProductData(SoldierDetail.BLACK_MONK, false, 1)}, new StorageData[]{}, 0, new EconomyEffect() {
        @Override
        public void applyEffect(Kingdom kingdom) {
            kingdom.addPopularity(2);
        }
    }, 1200, 0, 0, BuildingType.CATHEDRAL),
    ARMOURER(new ProductData[]{new ProductData(Weaponry.METAL_ARMOR, false, 1)}, new StorageData[]{}, 0, null, 300, 1, 0, BuildingType.ARMOURER),
    BLACKSMITH(new ProductData[]{new ProductData(Weaponry.MACE, false, 1), new ProductData(Weaponry.SWORD, false, 1)}, new StorageData[]{}, 0, null, 300, 1, 0, BuildingType.BLACKSMITH),
    FLETCHER(new ProductData[]{new ProductData(Weaponry.BOW, false, 1), new ProductData(Weaponry.CROSSBOW, false, 1)}, new StorageData[]{}, 0, null, 300, 1, 0, BuildingType.FLETCHER),
    POLE_TURNER(new ProductData[]{new ProductData(Weaponry.PIKE, false, 1), new ProductData(Weaponry.SPEAR, false, 1)}, new StorageData[]{}, 0, null, 300, 1, 0, BuildingType.POLE_TURNER),
    ...
    STABLE(new ProductData[]{}, new StorageData[]{new StorageData(BasicResource.HORSE, 4)}, 0, null, 300, 0, 0, BuildingType.STABLE),
    APPLE_ORCHARD(new ProductData[]{new ProductData(Food.APPLE, true, 10)}, new StorageData[]{}, 0, null, 100, 1, 0, BuildingType.APPLE_ORCHARD),
    ...
    HOPS_FARMER(new ProductData[]{new ProductData(BasicResource.HOPS, true, 10)}, new StorageData[]{}, 0, null, 100, 1, 0, BuildingType.HOPS_FARMER),
    HUNTER_POST(new ProductData[]{new ProductData(Food.MEAT, true, 10)}, new StorageData[]{}, 0, null, 100, 1, 0, BuildingType.HUNTER_POST),
    WHEAT_FARMER(new ProductData[]{new ProductData(BasicResource.WHEAT, true, 10)}, new StorageData[]{}, 0, null, 100, 1, 0, BuildingType.WHEAT_FARMER),
    BAKERY(new ProductData[]{new ProductData(Food.BREAD, true, 10)}, new StorageData[]{} , 0, null, 100, 1, 0, BuildingType.BAKERY),
    BREWER(new ProductData[]{new ProductData(Food.ALE, true, 10)}, new StorageData[]{}, 0, null, 100, 1, 0, BuildingType.BREWER),
    GRANARY(new ProductData[]{}, new StorageData[]{
    ...
    TOWN_BUILDING(new ProductData[]{}, new StorageData[]{new StorageData(BasicResource.GOLD, 0)}, Integer.MAX_VALUE, null, 4000, 0, 0, BuildingType.TOWN_BUILDING),
    UNEMPLOYED_PLACE(new ProductData[]{}, new StorageData[]{}, 0, null, Integer.MAX_VALUE, 0, 0, BuildingType.UNEMPLOYED_PLACE);
